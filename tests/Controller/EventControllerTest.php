...
final class EventControllerTest extends WebTestCase
{
    ...
    public function testEdit(): void
    {
        ...
        self::assertSame('Something New', $fixture[0]->getIsexpired());
    }
